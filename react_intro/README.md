...
You will need a favicon and the Holberton logo Add them to the `src/` directory under `dashboard/`
...
- Check that you can see the two elements on the browser, and using the 
